...
//      in = new Scanner(System.in);
   ...
   */
  public static void welcome (String name, Scanner input) throws Exception {
    String gaps = " ";
    String lineBreaks = "";
    for (int i = 0; i < 100; i++) {
    ...
    if ( (yOrN.equals ("n")) || (yOrN.equals ("N")) ) printRules (input);
    System.out.print ('\f');
  }
   ...
   */
  public static void printRules (Scanner sc) throws Exception {
    System.out.print ('\f');
